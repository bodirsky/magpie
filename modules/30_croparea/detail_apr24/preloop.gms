...
i30_rotation_rules(t_all,i,rota30) =
  f30_rotation_rules(rota30,"default") * (1-i30_rotation_scenario_fader(t_all) * p30_country_weight(i)) +
  f30_rotation_rules(rota30,"%c30_rotation_rules%") * (i30_rotation_scenario_fader(t_all) * p30_country_weight(i));
